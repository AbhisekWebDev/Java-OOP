public class Main {
    public static void main(String[] args) {
        ...
        Student student = new Student(); // encapsulation ka part, obj banaye
        student.setRoll(10); // encapsulation ka getter & setter
...
class Student { // encapsulation k liye class banaya
    private String name;
    private int roll;

    // dono k get ko call aur set ko call kiya niche
